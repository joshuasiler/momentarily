...
Momentary will then use a thread to complete your activity, rather than having your users wait. Note that you are responsible for ensuring that you provided Proc is thread safe. 
